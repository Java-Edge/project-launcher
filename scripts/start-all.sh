...
# 3. 启动 Hermes Agent 网关 UI (Dashboard)
start_service "🤖 Hermes Agent 网关 UI" "/Users/javaedge/.hermes/hermes-agent" "hermes dashboard --no-open --skip-build" "hermes-dashboard"

# 4. 启动 Local Control 服务器管理台
start_service "📡 Local Control 服务器管理台" "/Users/javaedge/soft/VSProjects/local-control" "npm run dev" "local-control"

# 5. 等待基础设施服务启动
sleep 5

# 6. 启动 Spring Boot 后端服务
...
echo "📊 服务概览:"
echo "   🌐 FRP 服务: 多个代理端口"
echo "   🤖 Hermes Agent UI: http://127.0.0.1:9119"
